...
commands_dict = {
    'commands': {
        ...
        'time': ['сколько сейчас время', 'время', 'сколько времени', 'который час'],
        'date': ['какое сегодня число', 'дата', 'какое число'],
        'wiki': ['поиск', 'узнай', 'википедия', 'найди'],
        'weather':['погода', 'какая сейчас погода', 'температура за бортом', 'что за окном']
    }
}
